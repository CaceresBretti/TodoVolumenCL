...
public class NewsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mNewsList = (RecyclerView) root.findViewById(R.id.NewsList);
        setupNewsList();
        setDummyContent();
        return root;
    }
    ...
    private void setupNewsList(){
        mNewsList.setLayoutManager(new GridLayoutManager(getActivity(), 1));
    ...
    private void setDummyContent(){
        ...
        for (int i = 0; i < 10; i++){
            noticias.add(new Noticia("Noticia " + i));
        }
